...
export default function FacadeLocalCTA() {
  return (
    <section className="relative overflow-hidden bg-[#f0ede5] py-24 text-[#111719] md:py-32 lg:py-40">
      <div
        className="pointer-events-none absolute -right-10 top-1/2 hidden -translate-y-1/2 font-serif text-[240px] italic leading-none text-black/[0.025] lg:block"
        aria-hidden="true"
      >
        Façade
      </div>
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-10">
        <div className="grid gap-12 md:grid-cols-12">
          <div className="md:col-span-7">
            ...
            <h2 className="mt-7 font-serif text-5xl leading-[0.97] tracking-[-0.03em] sm:text-6xl lg:text-7xl">
          ...
          <div className="md:col-span-4 md:col-start-9 md:self-end">
            <p className="text-sm leading-7 text-[#62635d]">
              Vous envisagez la remise en état ou la rénovation de
              l&apos;aspect extérieur de votre façade à Perpignan ou dans les
              environs ? Présentez-nous votre projet.
            </p>
